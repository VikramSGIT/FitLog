...
function useTimePicker({
  ...
  const handleTimeChange = (field, val) => {
    ...
    if (timeString.valid) {
      ...
      onChange == null ? void 0 : onChange(timeString.value);
    } else {
      acceptChange.current = false;
                ...
                (0, import_jsx_runtime13.jsx)(
                  SpinInput,
                  {
                    ...
                    onBlur: (event) => {
                      ...
                      (_a = hoursInputProps == null ? void 0 : hoursInputProps.onBlur) == null ? void 0 : _a.call(hoursInputProps, event);
                    },
...
var MiniCalendar = factory((_props, ref) => {
  ...
  const range = Array(numberOfDays).fill(0).map((_, index) => (0, import_dayjs48.default)(_date).add(index, "days")).map((date2) => {
    ...
    const dayProps = getDayProps == null ? void 0 : getDayProps(toDateString(date2));
    return (0, import_jsx_runtime40.jsxs)(
      UnstyledButton,
      {
        ...
        onClick: (event) => {
          var _a;
          (_a = dayProps == null ? void 0 : dayProps.onClick) == null ? void 0 : _a.call(dayProps, event);
          onChange == null ? void 0 : onChange(toDateString(date2));
        },
        ...getStyles("day", {
          active: !disabled,
          className: dayProps == null ? void 0 : dayProps.className,
          style: dayProps == null ? void 0 : dayProps.style
        }),
        children: [
  ...
  return (0, import_jsx_runtime40.jsxs)(Box, { ref, size, ...getStyles("root"), ...others, children: [
    (0, import_jsx_runtime40.jsx)(
      UnstyledButton,
      {
        ...
        children: (previousControlProps == null ? void 0 : previousControlProps.children) || (0, import_jsx_runtime40.jsx)(AccordionChevron, { "data-chevron": true, size })
      }
    ),
    ...
    (0, import_jsx_runtime40.jsx)(
      UnstyledButton,
      {
        ...
        children: (nextControlProps == null ? void 0 : nextControlProps.children) || (0, import_jsx_runtime40.jsx)(AccordionChevron, { "data-chevron": true, size })
      }
    )
  ] });
});
